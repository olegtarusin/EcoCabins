(() => {
    ...
    function initSliders() {
        if (document.querySelector(".material__slider")) new swiper_core_Swiper(".material__slider", {
            ...
            pagination: {
                el: ".material__pagination.swiper-pagination",
                clickable: true
            },
            on: {}
        });
    ...
    function changeHeader(e) {
        ...
        const titlepageHeight = titlepage.offsetHeight - header.offsetHeight;
        const headerScrolled = document.querySelector(".header__container.scrolled");
        if (scrollY >= titlepageHeight) header.classList.add("scrolled");
        if (headerScrolled && scrollY < titlepageHeight) header.classList.remove("scrolled");
    }
    window["FLS"] = true;
    isWebp();
    menuInit();
